...
(function () {
    ...
    kategorien: [
      {
        ...
        dienste: [{
          ...
          anbieter: 'Betreiber dieser Website, siehe Impressum',
  ...
  // Der Einleitungssatz muss zu dem passen, was die Seite wirklich laedt.
  // Ein Banner, das Google nennt, obwohl nichts von Google geladen wird,
  // widerspricht der eigenen Datenschutzerklaerung.
  function einleitungsText() {
    ...
    return 'Diese Website nutzt nur, was für den Betrieb nötig ist. Zusätzlich können wir ' +
           namen + ' einbinden. Beim Laden werden dabei Daten an den jeweiligen Anbieter ' +
           'übertragen, deshalb fragen wir vorher.';
  }
  ...
  function start() {
    ...
    // Ohne einwilligungspflichtigen Dienst gibt es nichts zu entscheiden. Ein
    // Banner waere dann eine Unterbrechung ohne Zweck. Sobald eine Kategorie
    // ohne pflicht:true konfiguriert ist, erscheint es automatisch. Mit
    // immerZeigen:true laesst es sich erzwingen.
    var brauchtBanner = KAT.some(function (k) { return !k.pflicht; }) || konf.immerZeigen === true;
    if (!entschieden && brauchtBanner) oeffne('kurz');
    else melden();
  }
